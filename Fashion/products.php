            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                            <img src="img/zara.jpg" alt="Sony DSLR" style="width: 200px; height: 300px">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Zara clothes kids</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/uniqlo.jpg" alt="Sony DSLR" style="width: 200px; height: 300px">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Uniqlo</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                            <img src="img/superdad.jpg" alt="Sony DSLR" style="width: 200px; height: 300px">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>T Shirt Super Dad</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                            <img src="img/cardigansweater.png" alt="Sony DSLR" style="width: 200px; height: 300px">
                            </a>
                            <center>
                                <div class="caption">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                            <img src="img/dresskoreanstyle.png" alt="Sony DSLR" style="width: 200px; height: 300px">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Dress Korean Style</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                            <img src="img/zeccroptopwace.webp" alt="Sony DSLR" style="width: 200px; height: 300px">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Zec Croptop Wace</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                            <img src="img/hoodiebeautifyoversize.webp" alt="Sony DSLR" style="width: 200px; height: 300px">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Hoodie Beautify</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/florallongsleeveshirts.webp" alt="Sony DSLR" style="width: 200px; height: 300px">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Floral long shirt</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                            <img src="img/boundless.webp" alt="Sony DSLR" style="width: 200px; height: 300px">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Boundless UE shirt</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                            <img src="img/erigotshirt.webp" alt="Sony DSLR" style="width: 200px; height: 300px">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Erigo T-shirt</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                            <img src="img/risrusfashion.webp" alt="Sony DSLR" style="width: 200px; height: 300px">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Risrus Fashion</h3>
                                    <p>Price: Rp. 900.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                            <img src="img/casual.webp" alt="Sony DSLR" style="width: 200px; height: 300px">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Casual pique ls</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                            <img src="img/erigo.webp" alt="Sony DSLR" style="width: 200px; height: 300px">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Erigo short shirt</h3>
                                    <p>Price: Rp. 1200.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
